...
assert.match(vnext,/Interactive connected-systems solar system/,'Connected Systems solar-system scene missing');
assert.match(vnext,/vnext-space-canvas/,'Solar-system canvas missing');
assert.match(vnext,/orbitPoint/,'Live orbit projection missing');
assert.match(read('portfolio-next.css'),/Flagship capability scene: animated solar-system model/,'Solar-system presentation styles missing');
...
console.log('Science-experiment release validation passed: 16 projects, 8,000 manifest records, solar-system interaction, deterministic science math and protected experience exclusions.');
