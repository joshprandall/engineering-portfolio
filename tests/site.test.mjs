...
for(const asset of ['portfolio-home.css','quantum-cube.js','assets/joshua-randall-cutout.webp','assets/systems-lab.jpg']) assert.ok(home.includes(asset)&&exists(asset),`Homepage asset missing: ${asset}`);
