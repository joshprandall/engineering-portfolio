...
assert.match(deployScript,/WEB_COMMIT = "394f7bb4a7bf79e970a39ce08f13bf4bc744220a"/,'OSU deploy must remain pinned to the validated project-navigation cleanup release');
