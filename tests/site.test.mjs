...
assert.match(deployScript,/WEB_COMMIT = "76f04335ef49dec31cbc704299c4a3502c68b4e6"/,'OSU deploy must remain pinned to the validated project-navigation cleanup release');
