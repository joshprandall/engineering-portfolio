...
for(const [command,args]of [[python[0],[...python.slice(1),'-m','py_compile','tools/repair-osu-portfolio.py','tools/deploy_osu_live.py']],[process.execPath,['tests/site.test.mjs']],[process.execPath,['tests/chess-rules.test.mjs']],[python[0],[...python.slice(1),'-m','unittest','discover','-s','tests','-p','test_*.py']]]){
