...
# Fill only genuinely missing images. Never replace the owner's existing photographs.
...
def main():
    ...
    try:
        ...
        # Only known web permissions; never chmod the whole home directory or all descendants.
        for name in ('','assets','games','games/evil-wizard','games/3d-battle-chess'):
